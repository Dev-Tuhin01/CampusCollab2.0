...
const Landing= () =>{
  ...
  <div className="flex items-center h-full w-full flex-col ">
    ...
    <nav className="grid grid-cols-2 gap-4 h-fit w-full justify-items-center grid-rows-2">
        ...
        <div className="w-11/12 mx-96 h-24 text-white flex items-center justify-center text-xl bg-neutral rounded"><Link to={"publishNotice"}> Publish Notice</Link></div>
        <div className="w-11/12 mx-96 h-24 text-white flex items-center justify-center text-xl bg-accent text-black rounded"><Link to={"addPaper"}> Add Paper</Link> </div>
    </nav>
  </div>
  )
}
