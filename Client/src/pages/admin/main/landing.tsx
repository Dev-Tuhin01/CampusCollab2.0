...
const Landing= () =>{
  ...
  <div className="flex items-center min-h-screen w-full flex-col ">
    ...
    <nav className="grid grid-cols-2 gap-4 size-full justify-items-center grid-rows-7 grid-cols-7 ">
        ...
        <Link to={"publishNotice"} className="w-11/12 row-start-5"><div className="h-24 text-white flex items-center justify-center text-xl bg-neutral rounded"> Publish Notice</div></Link>
